...
- Preserve or intentionally update `/manifest.json` `gitSync` when present. Do not store Git credentials, tokens, last-sync commits, or package hashes in the package; sync state is machine-local.
