...
6. Use the CLI for headless tasks that do not need visual editing: `thinkcomposer git status/pull/push`, `thinkcomposer report pdf`, and `thinkcomposer output generate`.
