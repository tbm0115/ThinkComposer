...
- [ ] For large generated machine-monitoring or device-model JSON, confirm GPT-generated files use `visualStrategy` instead of hand-placing/routing hundreds or thousands of objects by default.
