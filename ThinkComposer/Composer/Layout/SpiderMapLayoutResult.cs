...
{
    /// <summary>
    /// Summary of a Spider Map arrangement run.
    /// </summary>
    public class SpiderMapLayoutResult
    {
        public SpiderMapLayoutResult()
        {
        ...
        public VisualSymbol RootSymbol { get; set; }
        ...
        public int SkippedTotal
        {
            get
            {
                return this.ConceptsSkipped + (this.RoutingResult == null ? 0 : this.RoutingResult.Skipped);
            }
        }
